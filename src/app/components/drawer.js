...
export default function Drawer() {
  ...
  return (
    <div className={`flex flex-col p-2 xl:items-start fixed h-full xl:ml-24 bg-white w-3/5 justify-between z-50 shadow-sm shadow-slate-500 transition duration-300 sm:hidden visible  ${open ? "translate-x-0":"translate-x-[-100%]"}`}>
      {/* Logo */}
      <div>
